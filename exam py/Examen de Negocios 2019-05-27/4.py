def enunciaCantidad(n):
    ...
    return centenas[cen] + decenas[dec] + unidades[uni]

print(647, ':', enunciaCantidad(647))
print(30, ':', enunciaCantidad(30))
print(6, ':', enunciaCantidad(6))
print(100, ':', enunciaCantidad(100))